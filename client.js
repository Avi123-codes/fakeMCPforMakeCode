// ==UserScript==
// @name         MakeCode AI (local, full panel)
// @namespace    mcai.local
// @version      0.2
// @description  Connect MakeCode to your local AI backend with engine switcher
...
const BACKEND = "https://mcai.dev.tk.sg"; // your local server
const APP_TOKEN = "";                    // leave "" unless you set SERVER_APP_TOKEN in server/.env
...
(function(){
  ...
  // revert (NOTE: no duplicate const here)
